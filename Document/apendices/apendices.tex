...
Se utiliza la siguiente combinación de búsqueda por terminología, palabras clave y conceptos relacionados con metrología de vista única: \begin{lstlisting}[language=,basicstyle=\ttfamily\small,breaklines=true,frame=single,backgroundcolor=\color{gray!10}]
