...
\begin{figure}[!htp]
  ...
  \end{center}
  \caption[Visualización de distribución de los ángulos de cámara utilizado por~\cite{SVMIW}, basado en~\cite{CalibDataGeneration}.]{
  Visualización de distribución de los ángulos de cámara utilizado por~\cite{SVMIW}, basado en~\cite{CalibDataGeneration}.
