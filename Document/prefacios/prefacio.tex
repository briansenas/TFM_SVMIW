...
se obtuvo un error medio de $9.8\pm6.9$ cm. Este resultado es muy cercano al método
tradicional, que presenta un error medio de $6.7\pm5.6$ cm, con la ventaja adicional de no
...
In addition, multiple frames from surveillance cameras are used as an experimental validation dataset for this implementation.
\smallskip
...
mean error of $9.8\pm6.9$ cm. This result is very close to the traditional approach,
which exhibits a mean error of $6.7\pm5.6$ cm, while offering the additional advantage of
