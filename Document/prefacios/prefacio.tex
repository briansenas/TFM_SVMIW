...
en \emph{Single View Metrology in the Wild}, publicado en la \emph{European Conference on Computer Vision} en 2020.
\smallskip
...
se obtuvo un error medio de $12\pm8$ cm. Este resultado es superior al método
tradicional, que presenta un error medio de $37\pm26$ cm, con la ventaja adicional de no
...
\emph{Single View Metrology in the Wild}, presented at the European Conference on Computer Vision in 2020.
\smallskip

The method is implemented using the recent object detection framework Detectron2,
...
mean error of $12\pm8$ cm. This result is superior to the traditional approach,
which exhibits a mean error of $37\pm26$ cm, while offering the additional advantage of
