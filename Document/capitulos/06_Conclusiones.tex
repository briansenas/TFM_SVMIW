...
En total se obtuvo 697 imágenes válidas con etiquetas reales de la posición de la cámara, del sujeto y su altura.
Entre ellas, hay 12 sujetos diferentes, con alturas entre 1.60 y 1.92 metros.
...
frente al método clásico. El disponer de una regularización sobre el valor medio
...
las mediciones de referencia). El error medio del método clásico es de 37 centímetros
