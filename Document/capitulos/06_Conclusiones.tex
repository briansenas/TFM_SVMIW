...
así cómo métodos que utilizan técnicas de aprendizaje profundo.
...
Es entrenado en 3 fases, siendo las dos últimas utilizando 2 conjuntos de datos a
...
extensible para cualquier objeto). Se realiza una exploración de datos, comparando los métodos de generación de datos sintéticos
de~\cite{SVMIW} y~\cite{SPEC}. Incluyendo la eliminación de imágenes irrelevantes, gracias al desarrollo
de un sistema de visualización y búsqueda de imágenes según características extraídas automáticamente,
permitiendo encontrar imágenes redundantes para reducir el tamaño y ruido del conjunto de datos.
...
El campo de estimación de profundidad, utiliza la coherencia entre escenas en un video
