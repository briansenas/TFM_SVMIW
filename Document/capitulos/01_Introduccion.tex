...
\begin{figure}[!ht]
  ...
  Una posible aplicación directa de establecer dichas relaciones, es la inserción de objetos en la escena (derecha).}\label{fig:SVM}
\end{figure}
...
donde estas condiciones raramente se cumplen. Además, factores como la iluminación variable, la distorsión de la lente, la oclusión,
...
\end{center}
\caption[Ilusión óptica, la habitación de Ames~\cite{VisionBookMIT}.]{Ilusión óptica que ocasiona a que un mismo objeto (en este caso, el muñeco de LEGO®) se vea de diferente tamaño según la posición en la que se encuentre en la habitación
...
% NOTE : Incluir alguna imagen que especifique las diferencias entre los métodos?
\begin{enumerate}
...
\hline
\rowcolor[HTML]{FFC702}
Tarea & Semanas - Horas & Mayo & Junio & Julio & Agosto & Septiembre & Octubre & Noviembre & Diciembre & Enero & Febrero & Marzo & Abril & Mayo & Junio \\
\hline
