...
las cámaras en conjunto es de 9.8 centímetros, se encuentra en el mismo orden de magnitud que el método de calibración manual de escena.
...
junto a posibles problemas de aprendizaje del modelo hacen que el estimador estático presente un error medio absoluto menor.
...
\begin{table}[ht]
  ...
  del valor de altura media (1.75 metros) presente un menor error medio. Aún así, dichos resultados se alcanzan de forma semi-supervisada y con un bajo número de iteraciones,
