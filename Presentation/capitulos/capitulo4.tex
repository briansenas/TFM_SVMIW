...
\note{
  Para hablar del método por aprendizaje profundo, primero se necesita evaluar la calidad de la implementación frente al artículo de referencia.
...
\begin{frame}
  \begin{itemize}
    ...
    \item KITTI-person* consiste de 1352 imágenes frente a las 298 utilizadas por Rui Zhu~\emph{et al}~\footcite{SVMIW}.
  \end{itemize}
\begin{table}[!ht]
  \centering
  \scriptsize
...
\note{
  ...
  también están en el mismo orden magnitud. Siendo ambas cosas indicativos de que el modelo parece ser capaz
  de minimizar las funciones de pérdida y replicar el comportamiento esperado.
}
...
\note{
  Al estudiar las predicciones del modelo se observa un efecto de regresión hacia el a priori,
...
\note{
  ...
  conjunto de datos posee muchos fotogramas para el sujeto con 1.90 metros y no siempre preserva la consistencia en las predicciones para todos los fotogramas.
}
...
\note{
  ...
  Esto es un indicativo que minimizar el error de reproyección sin suposiciones adicionales de la escena
