...
\begin{frame}
  ...
  \end{tabular}
  \caption{
  Tabla de errores de estimación del método de calibración manual, expresados en centímetros.
  }
  \end{table}
\end{frame}
...
\begin{table}
  ...
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption[Tabla resumen de comparativa final, con errores expresados en centímetros.]{
  Tabla resumen de comparativa final, con errores expresados en centímetros.
  }
\end{table}
\end{frame}
