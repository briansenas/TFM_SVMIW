...
\begin{frame}
  ...
  \begin{itemize}
    \item El aprendizaje profundo alcanza increíbles resultados en diversos campos.
      ...
      \end{itemize}
    \item Existen diversos métodos para la calibración automática de escena por aprendizaje profundo.
    \item Algunos combinan principios geométricos con modelos de aprendizaje profundo~\footnotemark.
  \end{itemize}
  \footcitetext{SVMIW}
\end{frame}
\note{
