...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item Se dispone de una implementación de Rui Zhu \emph{et al.}~\footcite{SVMIW}, abriendo puertas a trabajos futuros.
      \begin{itemize}
...
\note{
  ...
  Aunque el método no supera al clásico de calibración manual, permitir automatizar y democratizar el proceso.
