\section{Procedimiento Zhu~\emph{et al}.}
\begin{frame}
...
\begin{figure}[!ht]
  \centering
  \subfloat{\includegraphics[width=.5\textwidth]{imagenes/appendix/office_measuring_desk.png}}\\
\end{figure}
\end{frame}
...
\begin{figure}[!ht]
  \centering
  \subfloat{\includegraphics[width=0.5\textwidth]{imagenes/appendix/worst_fail_cam1_svmiw.png}}
  \subfloat{\includegraphics[width=0.5\textwidth]{imagenes/appendix/worst_fail_cam2_svmiw.png}}\\
...
\begin{figure}[!ht]
  \centering
  \subfloat{\includegraphics[width=1\textwidth]{imagenes/appendix/170-decrease-with-distance.png}}\\
...
\begin{frame}
  ...
  \begin{center}
    ...
    \end{tikzpicture}\\
    \subfloat{\includegraphics[width=0.35\textwidth]{imagenes/appendix/pitch_spec_dist.png}}
    \subfloat{\includegraphics[width=0.35\textwidth]{imagenes/appendix/roll_spec_dist.png}}
    \subfloat{\includegraphics[width=0.35\textwidth]{imagenes/appendix/vfov_spec_dist.png}}
  \end{center}
